...
export const deleteTodo = (id) => axios.get(API_TODO_BASE_URL + '/' + id)
export const completeTodo = (id) => axios.get(API_TODO_BASE_URL + '/' + id + '/complete')
export const inCompleteTodo = (id) => axios.get(API_TODO_BASE_URL + '/' + id + '/in-complete')
